...
def update():
    ...
    if driveB == True:
        ...
        if counter < limits[1]:
            ...
            rc.drive.set_speed_angle(forward_speed, -.1)

        elif counter < limits[4]:
            rc.drive.set_speed_angle(turn_speed, .8)

        elif counter < limits[5]:
            rc.drive.set_speed_angle(forward_speed, 0)

        elif counter < limits[6]:
            rc.drive.set_speed_angle(turn_speed, .7)
    ...
    if driveX == True:   
        ...
        if counter < 1.2:
            ...
            rc.drive.set_speed_angle(.4, .8)
        elif counter < 7:
            rc.drive.set_speed_angle(0.6, -.7)
        elif counter < 12:
            rc.drive.set_speed_angle(0.5, -.8)
        elif counter < 14.4:
            rc.drive.set_speed_angle(0.7, .2)
        elif counter < 17:
            rc.drive.set_speed_angle(0.5, .8)
        elif counter < 26:
            rc.drive.set_speed_angle(0.4, 1)
        if counter > 26:
             rc.drive.stop()
